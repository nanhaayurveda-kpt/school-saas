      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-red-500 text-white px-5 py-2.5 rounded-lg hover:bg-red-600 text-sm font-medium"
            >
              Delete
            </button>
          </form>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 max-w-2xl space-y-6">
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-900 font-medium">{s.father_name || "—"}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500 uppercase font-medium mb-1">
              Phone
            </p>
            <p className="text-gray-900 font-medium">{s.phone || "—"}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500 uppercase font-medium mb-1">
              Admission Date
